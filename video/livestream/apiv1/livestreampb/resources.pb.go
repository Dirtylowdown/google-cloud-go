...
func (LogConfig_LogSeverity) Type() protoreflect.EnumType {
	return &file_google_cloud_video_livestream_v1_resources_proto_
...
func (Asset_State) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_video_livestream_v1_resources_proto_rawDescGZIP(), []in
}
...
type Input struct {
	...
	InputStreamProperty *InputStreamProperty `protobuf:"bytes,15,opt,name=input_stream_property,json=inputStreamProperty,proto3" json:"input_InputAttachment `protobuf:"bytes,16,rep,name=input_attachments,json=inputAttachments,proto3" json:"input_attachments,omitempty"`
	// Output only. The
	// [InputAttachment.key][google.cloud.video.livestream.v1.InputAttachment.key]
	// that serves [[google.cloud.video.attachments]
